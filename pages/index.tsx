  ...
  return (
      <>
          <Space direction="vertical" size="large">
              <Paragraph>Welcome to Football Forecaster, the ultimate destination for anyone looking to gain an edge in fantasy football drafts. Our web app is designed to help you navigate the complex world of fantasy football with ease, using advanced data analytics and machine learning to provide you with the insights you need to make informed decisions. With Football Forecaster, you&apos;ll have access to the latest player projections, rankings, and other key data points, allowing you to build a winning team and stay ahead of the competition.</Paragraph>
